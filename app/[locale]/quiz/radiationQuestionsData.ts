...
export const radiationQuestionsData: Record<number, ModuleQuestions> = {
  1: {
    en: [
      ...
      {
        question:
          'Depending on the carriers of energy, radiation can be classified into:',
        answers: [
      ...
      {
        question: 'Which of the following is classified as particle radiation?',
        answers: ['Gamma rays', 'Photons', 'Electrons', 'Infrared radiation'],
      ...
      },
      {
        ...
        answers: ['Speed', 'Amplitude', 'Frequency', 'Wavelength'],
        correctAnswerIndex: 2,
      },
      {
        question:
          'Which type of electromagnetic radiation has sufficient energy to ionize matter and is therefore important in radiation protection?',
        answers: [
      ...
      {
        question:
          'In alpha decay, an unstable parent nucleus transforms into a more stable nucleus by emitting:',
        answers: [
      ...
      {
        question:
          'In beta minus decay, a neutron-rich parent nucleus converts one of its neutrons into a proton and emits:',
        answers: [
          'A positron',
          'An alpha particle',
          'A neutron',
      ...
      {
        question:
          'In beta plus decay, a proton-rich parent nucleus converts one of its protons into a neutron and emits:',
        answers: ['A neutron', 'A proton', 'An electron', 'A positron'],
        correctAnswerIndex: 3,
      },
      {
        question:
          'In gamma decay, an excited nucleus releases its excess energy in the form of:',
        answers: [
      ...
      {
        question:
          'A radioactive sample is said to have high activity. What does this imply?',
        answers: [
      ...
      {
        question:
          'A radionuclide sample has an activity of 1000 Bq (1000 decays per second). After one half-life, the activity will be:',
        answers: ['500 Bq', '750 Bq', '250 Bq', '100 Bq'],
        correctAnswerIndex: 0,
      },
    ],
    el: [
      ...
      {
        question:
          'Ανάλογα µε τους φορείς ενέργειας, η ακτινοβολία ταξινοµείται σε:',
        answers: [
      ...
      {
        question:
          'Ποιο από τα παρακάτω ταξινοµείται ως σωµατιδιακή ακτινοβολία;',
        answers: [
          'Ακτίνες γάµµα',
          'Φωτόνια',
          'Ηλεκτρόνια',
      ...
      {
        question:
          'Η ενέργεια της ηλεκτροµαγνητικής ακτινοβολίας είναι ανάλογη µε:',
        answers: [
          'Την ταχύτητα',
          'Το πλάτος',
          'Την συχνότητα',
      ...
      {
        question:
          'Ποιος τύπος ηλεκτροµαγνητικής ακτινοβολίας έχει επαρκή ενέργεια για να ιονίσει την ύλη και εποµένως είναι σηµαντικός στην ακτινοπροστασία;',
        answers: [
      ...
      {
        question: 'Ιοντισμός συµβαίνει όταν:',
        answers: [
      ...
      {
        question:
          'Στη διάσπαση άλφα, ένας ασταθής πυρήνας µετατρέπεται σε πιο σταθερό εκπέµποντας:',
        answers: [
      ...
      {
        question:
          'Στη διάσπαση βήτα µείον, ένας πυρήνας πλούσιος σε νετρόνια µετατρέπει ένα νετρόνιο σε πρωτόνιο και εκπέµπει:',
        answers: [
          'Ένα ποζιτρόνιο',
          'Ένα σωµατίδιο άλφα',
          'Ένα νετρόνιο',
      ...
      {
        question:
          'Στη διάσπαση βήτα συν, ένας πυρήνας πλούσιος σε πρωτόνια µετατρέπει ένα πρωτόνιο σε νετρόνιο και εκπέµπει:',
        answers: [
          'Ένα νετρόνιο',
          'Ένα πρωτόνιο',
          'Ένα ηλεκτρόνιο',
      ...
      {
        question:
          'Στη διάσπαση γάµµα, ένας διεγερµένος πυρήνας εκπέµπει την περίσσεια ενέργειάς του µε τη µορφή:',
        answers: [
      ...
      {
        question:
          'Ένα ραδιενεργό δείγµα λέγεται ότι έχει υψηλή ενεργότητα. Τι σηµαίνει αυτό;',
        answers: [
      ...
      {
        question:
          'Ο χρόνος ηµιζωής ενός ραδιονουκλιδίου είναι ο χρόνος που απαιτείται για:',
        answers: [
      ...
      {
        question:
          'Ένα δείγµα έχει ενεργότητα 1000 Bq (1000 διασπάσεις ανά δευτερόλεπτο). Μετά από διάστηµα ενός χρόνου ηµιζωής, η ενεργότητα θα είναι:',
        answers: ['500 Bq', '750 Bq', '250 Bq', '100 Bq'],
        correctAnswerIndex: 0,
      },
    ],
  ...
  2: {
    en: [
      ...
      {
        question:
          'A radiation beam is unable to remove electrons from atoms but can excite them. How should this radiation be classified?',
        answers: [
      ...
      {
        question:
          'Charged particles (such as electrons and protons) deposit energy directly through interactions with matter. How is this radiation classified?',
        answers: [
      ...
      {
        question:
          'A photon collides with an outer-shell electron, ejecting it and continuing with reduced energy. Which interaction is this?',
        answers: [
      ...
      {
        question:
          'Why is Compton scattering particularly important in radiation protection?',
        answers: [
      ...
      {
        question:
          'A photon is completely absorbed and an inner-shell electron is ejected. What interaction occurred?',
        answers: [
          'Compton scattering',
          'Photoelectric effect',
          'Pair production',
      ...
      {
        question:
          'A high-energy photon disappears and produces an electron and a positron. Which interaction is this?',
        answers: [
          'Photoelectric effect',
          'Compton scattering',
          'Ionization',
      ...
      {
        question:
          'A beam of photons passes through a material and only some photons interact, while others continue unaffected. What does this demonstrate?',
        answers: [
      ...
      {
        question:
          'A photon beam decreases in intensity as it passes through material. What explains this behavior?',
        answers: [
      ...
      {
        question:
          'The Half-Value Layer (HVL) is the thickness of material that:',
        answers: [
      ...
      {
        question:
          'If the thickness of a material has two half-value layers (HVLs), what fraction of the beam passes through it?',
        answers: ['50%', '25%', '75%', '10%'],
        correctAnswerIndex: 1,
      },
      {
        question:
          'In general, energetic charged particles interacting with matter:',
        answers: [
    ...
    el: [
      {
        question: 'Η ιοντίζουσα ακτινοβολία ορίζεται ως ακτινοβολία που:',
        answers: [
          'Παράγει θερµότητα',
      ...
      {
        question:
          'Μια δέσµη ακτινοβολίας δεν µπορεί να αποµακρύνει ηλεκτρόνια από τα άτοµα αλλά µπορεί να τα διεγείρει. Πώς ταξινοµείται αυτή η ακτινοβολία;',
        answers: [
          'Μη ιοντίζουσα ακτινοβολία',
          'ιοντίζουσα ακτινοβολία',
          'Άµεσα ιοντίζουσα ακτινοβολία',
          'Δευτερογενής ακτινοβολία',
        ],
        correctAnswerIndex: 0,
      },
      {
        question: 'Γιατί τα φωτόνια θεωρούνται έµµεσα ιοντίζουσα ακτινοβολία;',
        answers: [
      ...
      {
        question:
          'Τα φορτισµένα σωµατίδια (όπως ηλεκτρόνια και πρωτόνια) αποθέτουν ενέργεια απευθείας µέσω αλληλεπιδράσεων µε την ύλη. Πώς ταξινοµείται αυτή η ακτινοβολία;',
        answers: [
          'Έµµεσα ιοντίζουσα ακτινοβολία',
          'Μη ιοντίζουσα ακτινοβολία',
          'Άµεσα ιοντίζουσα ακτινοβολία',
      ...
      {
        question:
          'Ένα φωτόνιο συγκρούεται µε ένα ηλεκτρόνιο εξωτερικού φλοιού, το εκτοξεύει και συνεχίζει µε µειωµένη ενέργεια. Ποια αλληλεπίδραση είναι αυτή;',
        answers: [
      ...
      {
        question:
          'Γιατί η σκέδαση Compton είναι ιδιαίτερα σηµαντική στην ακτινοπροστασία;',
        answers: [
      ...
      {
        question:
          'Ένα φωτόνιο απορροφάται πλήρως και ένα ηλεκτρόνιο εσωτερικού φλοιού εκτοξεύεται. Ποια αλληλεπίδραση συνέβη;',
        answers: [
          'Σκέδαση Compton',
          'Φωτοηλεκτρικό φαινόµενο',
          'Δηµιουργία ζεύγους',
      ...
      {
        question:
          'Ένα φωτόνιο υψηλής ενέργειας εξαφανίζεται και δηµιουργεί ένα ηλεκτρόνιο και ένα ποζιτρόνιο. Ποια αλληλεπίδραση είναι αυτή;',
        answers: [
          'Φωτοηλεκτρικό φαινόµενο',
          'Σκέδαση Compton',
          'Ιοντισμός',
      ...
      {
        question:
          'Μια δέσµη φωτονίων διέρχεται από υλικό και µόνο µερικά φωτόνια αλληλεπιδρούν, ενώ άλλα συνεχίζουν ανεπηρέαστα. Τι δείχνει αυτό;',
        answers: [
      ...
      {
        question:
          'Μια δέσµη φωτονίων µειώνεται σε ένταση καθώς διέρχεται από υλικό. Πώς εξηγείται αυτό;',
        answers: [
      ...
      {
        question:
          'Αν το πάχος ενός υλικού είναι δύο πάχη ηµιεξασθένησης (HVL), ποιο ποσοστό της δέσµης το διαπερνά;',
        answers: ['50%', '25%', '75%', '10%'],
        correctAnswerIndex: 1,
      },
      {
        question:
          'Γενικά, τα ενεργητικά φορτισµένα σωµατίδια όταν αλληλεπιδρούν µε την ύλη:',
        answers: [
  ...
  3: {
    en: [
      {
        question:
          'Which type of cell is generally most radiosensitive and why?',
        answers: [
      ...
      {
        question:
          'Why are germ cells particularly important in radiation protection?',
        answers: [
      ...
      {
        question:
          'A cell exposed to radiation pauses its progression to repair DNA damage. What mechanism is responsible for this?',
        answers: [
          'Apoptosis',
      ...
      {
        question:
          'Which natural source contributes most to average radiation exposure?',
        answers: [
      ...
      {
        question:
          'Which artificial source contributes most to population exposure?',
        answers: [
          'Nuclear accidents',
          'Industrial sources',
      ...
      {
        question:
          'A cell successfully repairs radiation-induced DNA damage. What is the outcome?',
        answers: [
          'Mutation',
      ...
      {
        question:
          'What is the most likely outcome when radiation-induced cellular damage is extensive and too severe?',
        answers: [
      ...
      {
        question:
          'How does a low dose rate influence radiation-induced damage?',
        answers: [
      ...
      {
        question:
          'Compared to adults, children are more radiosensitive because:',
        answers: [
    ...
    el: [
      {
        question:
          'Ποιος τύπος κυττάρων είναι γενικά πιο ακτινοευαίσθητος και γιατί;',
        answers: [
      ...
      {
        question:
          'Γιατί τα γαµετικά κύτταρα είναι ιδιαίτερα σηµαντικά στην ακτινοπροστασία;',
        answers: [
      ...
      {
        question:
          'Ένα κύτταρο που εκτίθεται σε ακτινοβολία σταµατά την πρόοδό του για να επιδιορθώσει βλάβες στο DNA. Ποιος µηχανισµός είναι υπεύθυνος;',
        answers: [
          'Απόπτωση',
      ...
      {
        question:
          'Ποια φυσική πηγή συµβάλλει περισσότερο στη µέση έκθεση του πληθυσµού σε ακτινοβολία;',
        answers: [
      ...
      {
        question:
          'Ποια τεχνητή πηγή συµβάλλει περισσότερο στην έκθεση του πληθυσµού;',
        answers: [
          'Πυρηνικά ατυχήµατα',
          'Βιοµηχανικές πηγές',
          'Ιατρικές εφαρµογές',
      ...
      {
        question:
          'Ένα κύτταρο επιδιορθώνει επιτυχώς βλάβες στο DNA που προκλήθηκαν από ακτινοβολία. Ποιο είναι το αποτέλεσµα;',
        answers: [
          'Μετάλλαξη',
      ...
      {
        question:
          'Ποιο είναι το πιθανότερο αποτέλεσµα όταν η κυτταρική βλάβη από ακτινοβολία είναι εκτεταµένη και πολύ σοβαρή;',
        answers: [
      ...
      {
        question:
          'Πώς επηρεάζει ένας χαµηλός ρυθµός δόσης τη βλάβη από ακτινοβολία;',
        answers: [
      ...
      {
        question:
          'Σε σύγκριση µε τους ενήλικες, τα παιδιά είναι πιο ακτινοευαίσθητα επειδή:',
        answers: [
      ...
      {
        question:
          'Γιατί οι στοχαστικές επιδράσεις χαρακτηρίζονται ως πιθανοκρατικές;',
        answers: [
      ...
      {
        question:
          'Ποια δήλωση περιγράφει καλύτερα την ακτινοευαισθησία του εµβρύου;',
        answers: [
  ...
  4: {
    en: [
      {
        question:
          'The system of radiation protection is designed to balance the risks and benefits of radiation use. Which of the following best describes its primary goal?',
        answers: [
      ...
      {
        question:
          'In Greece, which authority is responsible for radiation protection regulation and supervision?',
        answers: [
          'Ministry of Health',
      ...
      {
        question:
          'A hospital performing routine diagnostic X-ray examinations is an example of which exposure situation?',
        answers: ['Emergency', 'Existing', 'Accidental', 'Planned'],
        correctAnswerIndex: 3,
      },
      {
        question:
          'A malfunction that could lead to unintended patient overexposure is classified as:',
        answers: [
          'Normal exposure',
          'Potential exposure',
          'Existing exposure',
      ...
      {
        question:
          'A nuclear accident requiring urgent response is classified as:',
        answers: [
          'Emergency exposure',
      ...
      },
      {
        ...
        answers: ['Planned', 'Emergency', 'Occupational', 'Existing'],
        correctAnswerIndex: 3,
      },
      {
        question:
          'A radiology technologist working with X-ray equipment is subject to:',
        answers: [
          'Occupational exposure',
      ...
      {
        question:
          'A visitor in a hospital waiting room exposed to background radiation is considered:',
        answers: [
      ...
      {
        question:
          'Why are non-radiation healthcare workers considered members of the public in radiation protection?',
        answers: [
      ...
      {
        question:
          'The ALARA (as low as reasonably achievable) principle refers to:',
        answers: [
      ...
      {
        question:
          'Why is absorbed dose alone insufficient to describe biological effects?',
        answers: [
      ...
      {
        question:
          'The average annual effective dose from background radiation is 2–3 mSv. What is the annual effective dose limit for the public in planned exposure situations?',
        answers: ['3 mSv', '5 mSv', '1 mSv', '10 mSv'],
        correctAnswerIndex: 2,
      },
      {
        question:
          'Why must special radiation protection measures be taken for pregnant workers?',
        answers: [
    ...
    el: [
      {
        question:
          'Το σύστηµα ακτινοπροστασίας έχει σχεδιαστεί για να εξισορροπεί τους κινδύνους και τα οφέλη από τη χρήση της ακτινοβολίας. Ποιο από τα παρακάτω περιγράφει καλύτερα τον κύριο στόχο του;',
        answers: [
      ...
      {
        question:
          'Στην Ελλάδα, ποια αρχή είναι υπεύθυνη για τη ρύθµιση και εποπτεία της ακτινοπροστασίας;',
        answers: [
          'Υπουργείο Υ γείας',
      ...
      {
        question:
          'Ένα νοσοκοµείο που πραγµατοποιεί συνήθεις διαγνωστικές εξετάσεις ακτίνων Χ αποτελεί παράδειγµα ποιας κατηγορίας έκθεσης;',
        answers: [
      ...
      {
        question:
          'Μια δυσλειτουργία που θα µπορούσε να οδηγήσει σε ακούσια υπερέκθεση ασθενούς ταξινοµείται ως:',
        answers: [
          'Κανονική έκθεση',
          'Δυνητική έκθεση',
          'Υ φιστάµενη έκθεση',
      ...
      {
        question:
          'Ένα πυρηνικό ατύχηµα που απαιτεί άµεση ανταπόκριση ταξινοµείται ως:',
        answers: [
          'Έκθεση έκτακτης ανάγκης',
      ...
      {
        question:
          'Ένας τεχνολόγος ακτινολογίας που εργάζεται µε εξοπλισµό ακτίνων Χ υπόκειται σε:',
        answers: [
          'Επαγγελµατική έκθεση',
      ...
      {
        question:
          'Ένας ασθενής που υποβάλλεται σε αξονική τοµογραφία αποτελεί παράδειγµα:',
        answers: [
          'Ιατρικής έκθεσης',
          'Τυχαίας έκθεσης',
      ...
      {
        question:
          'Ένας επισκέπτης σε χώρο αναµονής νοσοκοµείου που εκτίθεται σε φυσική ακτινοβολία θεωρείται:',
        answers: [
      ...
      {
        question:
          'Γιατί οι επαγγελµατίες υγείας που δεν εργάζονται µε ακτινοβολία θεωρούνται µέλη του κοινού στο πλαίσιο της ακτινοπροστασίας;',
        answers: [
      ...
      },
      {
        ...
        answers: [
          ...
          'Κάθε χρήση ιοντίζουσας ακτινοβολίας πρέπει να προσφέρει περισσότερο όφελος παρά βλάβη',
      ...
      {
        question:
          'Η αρχή ALARA (όσο το δυνατόν χαµηλότερα, λαµβάνοντας υπόψη οικονοµικούς και κοινωνικούς παράγοντες) αναφέρεται σε:',
        answers: [
      ...
      {
        question:
          'Γιατί η απορροφούµενη δόση από µόνη της δεν επαρκεί για την περιγραφή των βιολογικών επιδράσεων;',
        answers: [
          'Επειδή δεν λαµβάνει υπόψη το είδος της ακτινοβολίας',
          'Επειδή εφαρµόζεται µόνο σε φωτόνια',
          'Επειδή εφαρµόζεται µόνο σε µη ιοντίζουσα ακτινοβολία',
      ...
      {
        question:
          'Η µέση ετήσια ενεργός δόση από φυσική ακτινοβολία είναι 2–3 mSv. Ποιο είναι το ετήσιο όριο ενεργού δόσης για το κοινό σε σχεδιασµένες καταστάσεις έκθεσης;',
        answers: ['3 mSv', '5 mSv', '1 mSv', '10 mSv'],
        correctAnswerIndex: 2,
      },
      {
        question:
          'Γιατί πρέπει να λαµβάνονται ειδικά µέτρα ακτινοπροστασίας για εγκύους εργαζόµενες;',
        answers: [
  ...
  5: {
    en: [
      {
        question:
          'Which of the following is NOT a fundamental principle of radiation protection?',
        answers: [
      ...
      {
        question:
          'Doubling the distance from a radiation source reduces exposure to approximately:',
        answers: ['Half', 'One-sixth', 'One-quarter', 'No change'],
        correctAnswerIndex: 2,
      },
      {
        question:
          'Which statement best explains the role of shielding in radiation protection?',
        answers: [
      ...
      {
        question:
          'The main source of occupational radiation exposure in radiology is:',
        answers: [
          'Primary beam',
      ...
      {
        question:
          'Mobile X-ray systems in wards, emergency departments, or intensive care units require special attention because:',
        answers: [
      ...
      {
        question:
          'Why is fluoroscopy particularly important from a staff radiation protection perspective?',
        answers: [
      ...
      {
        question:
          'A healthcare worker who is or may be pregnant is asked to participate in a procedure involving radiation exposure. What should be done?',
        answers: [
      ...
      {
        question:
          'In nuclear medicine, occupational exposure may occur through the following pathways:',
        answers: [
      ...
      {
        question:
          'If a worker’s skin becomes contaminated with radioactive material, what is the recommended immediate action?',
        answers: [
      ...
      {
        question:
          'If a worker’s eye becomes contaminated with radioactive material, what is the recommended immediate action?',
        answers: [
      ...
      {
        question:
          'In the event of a spill of radioactive material (e.g., bodily fluid), what is the most appropriate action?',
        answers: [
      ...
      {
        question:
          'A patient who has recently received a therapeutic radiopharmaceutical develops a life-threatening emergency. Which statement best reflects appropriate practice?',
        answers: [
      ...
      {
        question:
          'A radioactive patient requires urgent surgery. Why should the Radiation Protection Officer (RPO) be informed immediately?',
        answers: [
      ...
      {
        question:
          'What is the main purpose of interlocks in an external beam radiotherapy room?',
        answers: [
    ...
    el: [
      {
        question:
          'Ποιο από τα παρακάτω ΔΕΝ αποτελεί θεµελιώδη αρχή της ακτινοπροστασίας;',
        answers: [
      ...
      {
        question:
          'Η µείωση του χρόνου παραµονής κοντά σε µια πηγή ακτινοβολίας θα:',
        answers: [
      ...
      {
        question:
          'Ο διπλασιασµός της απόστασης από µια πηγή ακτινοβολίας µειώνει την έκθεση περίπου σε:',
        answers: ['Μισό', 'Ένα έκτο', 'Ένα τέταρτο', 'Καµία µεταβολή'],
        correctAnswerIndex: 2,
      },
      {
        question:
          'Ποια από τις παρακάτω δηλώσεις περιγράφει καλύτερα τον ρόλο της θωράκισης στην ακτινοπροστασία;',
        answers: [
      ...
      {
        question:
          'Ποιο από τα παρακάτω αποτελεί παράδειγµα ελεγχόµενης περιοχής;',
        answers: [
      ...
      {
        question:
          'Η κύρια πηγή επαγγελµατικής έκθεσης σε ακτινοβολία στην ακτινολογία είναι:',
        answers: [
          'Η πρωτογενής δέσµη',
      ...
      {
        question:
          'Τα φορητά συστήµατα ακτινογραφίας σε θαλάµους, τµήµατα επειγόντων περιστατικών ή µονάδες εντατικής θεραπείας απαιτούν ιδιαίτερη προσοχή επειδή:',
        answers: [
      ...
      {
        question:
          'Γιατί η ακτινοσκόπηση είναι ιδιαίτερα σηµαντική από την άποψη της ακτινοπροστασίας του προσωπικού;',
        answers: [
      ...
      {
        question:
          'Μια επαγγελµατίας υγείας που είναι ή ενδέχεται να είναι έγκυος καλείται να συµµετάσχει σε διαδικασία που περιλαµβάνει έκθεση σε ακτινοβολία. Τι πρέπει να γίνει;',
        answers: [
      ...
      {
        question:
          'Στην πυρηνική ιατρική, η επαγγελµατική έκθεση µπορεί να προκύψει µε τους εξής τρόπους:',
        answers: [
      ...
      {
        question:
          'Εάν το δέρµα ενός εργαζοµένου µολυνθεί µε ραδιενεργό υλικό, ποια είναι η συνιστώµενη άµεση ενέργεια;',
        answers: [
      ...
      {
        question:
          'Εάν το µάτι ενός εργαζοµένου µολυνθεί µε ραδιενεργό υλικό, ποια είναι η συνιστώµενη άµεση ενέργεια;',
        answers: [
      ...
      {
        question:
          'Σε περίπτωση διαρροής ραδιενεργού υλικού (π.χ. σωµατικού υγρού), ποια είναι η καταλληλότερη ενέργεια;',
        answers: [
      ...
      {
        question:
          'Ένας ασθενής που έχει πρόσφατα λάβει θεραπευτικό ραδιοφάρµακο εµφανίζει απειλητική για τη ζωή κατάσταση. Ποια δήλωση αντανακλά την ορθή πρακτική;',
        answers: [
      ...
      {
        question:
          'Ένας ραδιενεργός ασθενής χρειάζεται επείγουσα χειρουργική επέµβαση. Γιατί πρέπει να ενηµερωθεί άµεσα ο Υπεύθυνος Ακτινοπροστασίας (RPO);',
        answers: [
      ...
      {
        question:
          'Ποιος είναι ο κύριος σκοπός των συστηµάτων διασύνδεσης ασφαλείας (interlocks) σε µια αίθουσα εξωτερικής ακτινοθεραπείας;',
        answers: [
